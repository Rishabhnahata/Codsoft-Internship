...
class PasswordGenerator(Tk):
    ...
    def create_app_heading_frame(self):
        ...
        :return: the frame
        """
        frame = Frame(self, height = 50, bg = "red")
        frame.pack(fill = X)
        return frame
    ...
    def create_length_input_frame(self):
        ...
        :return: the frame
        """
        frame = Frame(self, bg = "white", height = 300, padx = 20, pady = 20)
    ...
    def create_password_length_label(self):
        ...
        """
        label = Label(self.length_input_frame, text = "Set password length", font = ("Helvetica", 16), bg = "blue", fg = "#1a0944")
